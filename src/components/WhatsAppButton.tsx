...
export default function WhatsAppButton() {
  const phoneNumber = "917503001001"; // Replace with actual number
  const message = "Hello, I am interested in your mustard products. Could you please provide more information?";
